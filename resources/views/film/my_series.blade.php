...
@section('content')
    <h1>Meine Serien <small><a href="{{url('series/view')}}">&raquo;Alle Serien</a></small></h1>
    @include('film.my_filters', ['query' => $query, 'filterService' => $filterService, 'action' => 'FilmController@mySeries'])
    <hr/>
