...
@section('content')
    <h1>Serien <small><a href="{{url('my/series')}}">&raquo;Meine Serien</a></small></h1>
    @include('film.filters', ['query' => $query, 'filterService' => $filterService, 'action' => 'FilmController@viewSeries', 'myName' => 'Meine Serien'])
    <hr/>
